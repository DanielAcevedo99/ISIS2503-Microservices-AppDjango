...
INSTALLED_APPS = [
    ...
    'places',  # Replace 'measurements' with 'places' for this app
]
...
ROOT_URLCONF = 'places.urls'  # Replace 'monitoring' with 'places'
...
WSGI_APPLICATION = 'places.wsgi.application'  # Replace 'monitoring' with 'places'
